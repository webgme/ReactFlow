...
define([
    ...
    'text!./templates/FlowLayout.html',
    'text!./FlowLayoutConfig.json'
], function(
    _jQueryLayout,
    Logger,
    ComponentSettings,
    ...
    var FlowLayout = function(params) {
        this._logger = (params && params.logger) || Logger.create('gme:Layouts:FlowLayout',
            WebGMEGlobal.gmeConfig.client.log);
        this.config = FlowLayout.getDefaultConfig();
        ComponentSettings.resolveWithWebGMEGlobal(this.config, FlowLayout.getComponentId());
    ...
    FlowLayout.getComponentId = function () {
        return 'FlowLayout';
    };

    FlowLayout.getDefaultConfig = function () {
        return CONFIG;
    };
     ...
     * @return {undefined}
     */
    FlowLayout.prototype.addToContainer = function(panel, container) {
        if (container === 'header') {
     ...
     * @return {undefined}
     */
    FlowLayout.prototype.remove = function(panel) {
     ...
     * @return {undefined}
     */
    FlowLayout.prototype.destroy = function() {
        this._body.empty();
    };
    ...
    FlowLayout.prototype._onCenterResize = function() {
        if (this._canvas) {
            this._canvas.setSize(this._centerPanel.width(), this._centerPanel.height());
        }
    };

    FlowLayout.prototype._onToolboxResize = function() {
        if (this._toolbox) {
